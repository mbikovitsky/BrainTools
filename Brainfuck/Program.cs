...
namespace Brainfuck
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Bitmap newBmp = EncodeBMP(bmp, code);
            string newCode = DecodeBraincopter(newBmp);
            Run(newCode);
        ...
        static string DecodeBraincopter(Bitmap bmp)
        {
            string code = "";
            Direction dir = Direction.east;
            int curX = 0, curY = 0;
        ...
        static Color GetClosest(Color origin, int cmd)
        {
